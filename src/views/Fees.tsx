...
import { Printer, Calculator, Download } from "lucide-react";
import { FEE_DATA, FEE_ADDITIONALS } from "@/lib/constants";
...
export default function Fees() {
  ...
  const tuition = FEE_DATA[form as keyof typeof FEE_DATA]?.[category as "Boarding" | "Day"] ?? 0;
    ...
    <div>
        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <h1 className="font-heading text-4xl md:text-5xl font-bold">
              {t("Fee Calculator", "Kikokotoo cha Ada", lang)}
            </h1>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto">
          <SectionHeader
            eyebrow={t("Transparent Fees", "Ada ya Wazi", lang)}
            title={t("Calculate Your", "Kokotoa", lang)}
            highlight={t("School Fees", "Ada yako", lang)}
          />
